  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 37, 37, 37)),
        useMaterial3: true,
      ),
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    setState(() {
      ...
      _players.add("player1"); // todo récup la valeur d'une messagebox qui demande le nom
    });
  }
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Row(
          ...
          children: <Widget>[
            CityWidget(playerName: 'player 1'),
          ],
        ),
      ),
